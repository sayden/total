// Code generated by goyacc -o gen_parser.go parser.y. DO NOT EDIT.
...
var yyAct = [...]int{
	20, 12, 5, 22, 7, 8, 6, 13, 15, 14,
	18, 8, 3, 21, 10, 9, 19, 5, 1, 17,
	16, 2, 23, 4, 11,
}

var yyPact = [...]int{
	1, -1000, -1000, 12, -1000, 0, -1000, 9, 7, -1000,
	-3, -6, -1000, -1000, -1000, -1000, -1000, -1000, -3, -1000,
	-11, -3, -1000, -1000,
}

var yyPgo = [...]int{
	0, 21, 19, 4, 13, 20, 0, 18,
}
...
var yyChk = [...]int{
	-1000, -7, -1, 11, -2, 5, 6, -3, 11, 6,
	7, -4, 4, 10, 12, 11, -5, -2, 13, -3,
	-6, -4, 14, -6,
}

var yyDef = [...]int{
	0, -2, 1, 0, 2, 0, 3, 0, 0, 4,
	0, 5, 7, 8, 9, 10, 11, 12, 0, 6,
	0, 14, 13, 15,
}
...
//line parser.y:41
		{
			setScl(yylex, yyDollar[1].result)
		}
	case 2:
...
//line parser.y:56
		{
			yyVAL.mapstr = map[string]interface{}{yyDollar[1].any.(string): yyDollar[2].ch}
		}
	case 6:
